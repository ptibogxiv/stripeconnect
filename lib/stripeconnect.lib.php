 ...
 */
function stripeconnectadmin_prepare_head()
{
	global $langs, $conf;
	...
	$head[$h][0] = dol_buildpath("/stripeconnect/admin/stripeconnect.php",1);
 ...
 * @return	void
 */
function html_print_stripeconnect_footer($fromcompany,$langs)
{
	global $conf;
